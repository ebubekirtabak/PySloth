...
class Logger:
    ...
    def set_error_log(self, data):
        print("Error:" + data)
        FileModule.write_file_line(script_dir, 'error_log.txt', 'Error: ' + str(time.strftime('%c')) + " : " + data)

    def set_memory_log(self, data):
        FileModule.write_file_line(script_dir, 'memory_logs/error_log' + str(time.time()) + '.txt',  str(time.strftime('%c')) + " : " + data)
